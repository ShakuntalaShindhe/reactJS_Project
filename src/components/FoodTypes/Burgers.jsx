...
import AllData from '../../assets/Data/burger.json'
...
export default function FoodMenu() {
  ...
  return (
    <div>
      <h1 className='Burger-heading'>Burgers</h1>
      ...
      <div className='card-grid-burger'>
        {filteritems.length > 0 && filteritems.map((item) => (
          <div key={item.id}  className='Burger-Cards'>
            ...
            <div className='info'>
              ...
              {AnythinginsideCart(item.id) ? <button onClick={() => handleDeleteCartItem(item.id)} className='btn'>Remove Item</button>
